...
export function PricingSection() {
    ...
    const onSubmit = async (data: SignupFormData) => {
        ...
        try {
            ...
            toast({ title: "Compte créé !", description: "Vous allez être redirigé pour finaliser votre abonnement." });
        ...
        <section className="bg-background text-foreground py-16 sm:py-24">
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="sm:max-w-md">
                     <DialogHeader>
                        <DialogTitle>Souscrire à l'offre "{selectedPlan?.name}"</DialogTitle>
                        <DialogDescription>Créez votre compte conseiller pour commencer.</DialogDescription>
                    </DialogHeader>
                     <Form {...form}>
