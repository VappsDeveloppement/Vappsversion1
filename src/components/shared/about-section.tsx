        ...
        <section className="bg-background text-foreground py-16 sm:py-24">
            <div className="container mx-auto px-4">
                <div className="text-center mb-12">
                    <h2 className="text-3xl lg:text-4xl font-bold">{aboutSettings?.mainTitle || "Trouver Votre Voie"}</h2>
                    <p className="text-lg text-primary mt-2">{aboutSettings?.mainSubtitle || "Une approche sur-mesure"}</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
                    ...
                    <p className="text-muted-foreground text-lg">
                        {aboutSettings?.mainText || "Chez Vapps, nous croyons qu'il n'existe pas de chemin unique. C'est pourquoi nous proposons une approche holistique et inclusive, qui prend en compte votre personnalité, vos compétences, vos envies et vos contraintes."}
                    </p>
                </div>

                <div className="text-center mb-12">
                    <h3 className="text-2xl lg:text-3xl font-bold">{aboutSettings?.pillarsSectionTitle || "Les piliers de notre accompagnement"}</h3>
                </div>
