             ...
             <AlertDialog open={!!userToDelete} onOpenChange={(open) => !open && setUserToDelete(null)}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>Cette action supprimera les données de l'utilisateur <strong>{userToDelete?.firstName} {userToDelete?.lastName}</strong> de la base de données. Le compte d'authentification devra être supprimé manuellement depuis la console Firebase.</AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
